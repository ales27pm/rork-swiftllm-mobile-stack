...
SWIFT_CLASS("_TtC12NeuralEngine29FirstRunPermissionCoordinator")
@interface FirstRunPermissionCoordinator : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class CLLocationManager;
@interface FirstRunPermissionCoordinator (SWIFT_EXTENSION(NeuralEngine)) <CLLocationManagerDelegate>
- (void)locationManagerDidChangeAuthorization:(CLLocationManager * _Nonnull)manager;
@end

@class CLLocation;
SWIFT_CLASS("_TtC12NeuralEngine12MapViewModel")
@interface MapViewModel : NSObject <CLLocationManagerDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC12NeuralEngine24SpeechRecognitionService")
@interface SpeechRecognitionService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC12NeuralEngine22SpeechSynthesisService")
...
@interface SpeechSynthesisService (SWIFT_EXTENSION(NeuralEngine)) <AVSpeechSynthesizerDelegate>
...
SWIFT_CLASS("_TtC12NeuralEngine12ToolExecutor")
@interface ToolExecutor : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@interface ToolExecutor (SWIFT_EXTENSION(NeuralEngine)) <CLLocationManagerDelegate>
- (void)locationManager:(CLLocationManager * _Nonnull)manager didUpdateLocations:(NSArray<CLLocation *> * _Nonnull)locations;
- (void)locationManager:(CLLocationManager * _Nonnull)manager didFailWithError:(NSError * _Nonnull)error;
@end

SWIFT_CLASS("_TtC12NeuralEngine16WeatherViewModel")
